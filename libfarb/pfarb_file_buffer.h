...
//    int                     *dimids;    /* array of dimension IDs */
    ...
    MPI_Offset              data_sz;    /*how much data has been written in bytes*/

    buffer_node_t           *bufnodes;  /*array of buffer nodes that stores the data*/
    MPI_Offset              bufnode_cnt;   /*number of allocated buffer nodes*/
...
typedef struct file_buffer{
  ...
  farb_var_t    *vars;              /*Variables in the file*/
