...
/**
  ...
  @param	connection		the connection instance on the client side
  @param	nb_groups		the number of ensemble members
  @param	recv_buffer		the buffer for storing the received data
...
/*-------------------------------------------------------------------------*/
/**
  @brief	alltoallv communication (send) targeting the 3D array on the server side
  @param	connection		the connection instance on the server side
  @param	nb_groups		the number of ensemble members
...
/*-------------------------------------------------------------------------*/
/**
  @brief	alltoallv communication (send) targeting the 2D array on the server side
  @param	connection		the connection instance on the server side
  @param	nb_groups		the number of ensemble members
  @param	send_buffer		the buffer for storing the sent data
  @param	datatype		datatype of each send buffer element (handle)
...
/*-------------------------------------------------------------------------*/
/**
  @brief	scatter the rows of a 2D array on the server side
  @param	connection			the connection instance on the server side
  @param	nb_groups			the number of ensemble members
  @param	send_buffer			the buffer for storing the sent data
  @param	datatype			datatype of each send buffer element (handle)
  @param	buffer_size			Each process may send a different amount of data (alltoallv)
  @param	row_send_count		length for each process in alltoallv
  @return	void
 */
/*--------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/**
  @brief	receive the rows of a 2D array on the client side
  @param	connection			the connection instance on the client side
  @param	nb_groups			the number of ensemble members
  @param	recv_buffer			the buffer for storing the received data
  @param	datatype			datatype of each send buffer element (handle)
  @param	buffer_size			Each process may send a different amount of data (alltoallv)
  @param	row_recv_count		length for each process in alltoallv
  @return	void
 */
/*--------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/**
  @brief	scatter the columns of a 2D array on the server side
  @param	connection			the connection instance on the server side
  @param	nb_groups			the number of ensemble members
  @param	send_buffer			the buffer for storing the sent data
  @param	datatype			datatype of each send buffer element (handle)
  @param	buffer_size			Each process may send a different amount of data (alltoallv)
  @param	col_send_count		length for each process in alltoallv
  @return	void
 */
/*--------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/**
  @brief	receive the columns of a 2D array on the client side
  @param	connection			the connection instance on the client side
  @param	nb_groups			the number of ensemble members
  @param	recv_buffer			the buffer for storing the received data
  @param	datatype			datatype of each send buffer element (handle)
  @param	buffer_size			Each process may send a different amount of data (alltoallv)
  @param	col_recv_count		length for each process in alltoallv
  @return	void
 */
/*--------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/**
  @brief	scatter an 1D array on the server side
  @param	connection			the connection instance on the server side
  @param	nb_groups			the number of ensemble members
  @param	send_buffer			the buffer for storing the sent data
  @param	sent_count			length for each process in alltoallv
  @return	void
 */
/*--------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/**
  @brief	receive the 1D array data on the client side
  @param	connection			the connection instance on the client side
  @param	nb_groups			the number of ensemble members
  @param	recv_buffer			the buffer for storing the received data
  @param	recv_count			length for each process in alltoallv
...
/**
  ...
  @param	service_name		name of the connection service
  @return 	server_conn			record the client information after the connection
 */
/*--------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/**
  @brief	connect to the published port
  @param	service_name		name of the connection service
  @return 	client_conn			record the server information after the connection
 */
/*--------------------------------------------------------------------------*/
